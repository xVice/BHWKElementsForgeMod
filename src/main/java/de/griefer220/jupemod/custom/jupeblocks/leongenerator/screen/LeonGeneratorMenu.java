package de.griefer220.jupemod.custom.jupeblocks.leongenerator.screen;
...
public class LeonGeneratorMenu extends AbstractContainerMenu {
    public final LeonGeneratorBlockEntity blockEntity;
    ...
    public LeonGeneratorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.LEON_GENERATOR_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((LeonGeneratorBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.leon_generator.get());
    }
